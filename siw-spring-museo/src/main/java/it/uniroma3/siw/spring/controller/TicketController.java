...
public class TicketController {
	...
	public String prenotaP(Model model, @PathVariable Long id,
			@ModelAttribute("ticket") TicketPrenotato ticketP) {
		Utente utente = getUtente();
		Ticket ticket = this.ticketService.findById(id);
	...
	public String viewTicket(Model model, @PathVariable Long id) {
		...
		ticketP.getTicket().setPosti_disponibili(ticketP.getTicket().getPosti_disponibili()+ticketP.getPosti_prenotati());
	...
	public String addTicketP(Model model, @ModelAttribute("ticket") Ticket ticket) {
